#[==[
Create a test for the mjolnir libraries and perform the setup using a keyword list.
...
-----------
    ...
    target:
        Name of the CMake target that should be used. The prefix "test_" is added
        automatically.
...
function(add_mjolnir_test target module)
    if(${MJOLNIR_${module}_ENABLE_TESTS})
        ...
        string(
            REPLACE "${MJOLNIR_${module}_ROOT_DIR}/tests/"
                    ""
                    relative_path
